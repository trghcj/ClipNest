      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-card rounded-xl border shadow-sm">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            Your intelligent bookmark management platform.
          </p>
        </div>
        ...
        <div className="pt-4">
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-input bg-background hover:bg-muted transition-colors rounded-lg font-medium shadow-sm text-foreground"
          >
